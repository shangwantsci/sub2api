...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/claude-pool',
    name: 'ClaudePool',
    component: () => import('@/views/public/ClaudePoolView.vue'),
    meta: {
      requiresAuth: false,
      title: 'Claude Pool'
    }
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/key-usage', '/setup', '/payment/result', '/payment/airwallex', '/legal', '/claude-pool']
