...
func init() {
	...
	groupDescAnthropicMixedTypeWeightEnabled := groupFields[44].Descriptor()
	...
	groupDescAnthropicSetupTokenPoolWeight := groupFields[45].Descriptor()
	...
	groupDescAnthropicAPIKeyPoolWeight := groupFields[46].Descriptor()
