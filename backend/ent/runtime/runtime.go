...
func init() {
	...
	// accountDescPoolWeight is the schema descriptor for pool_weight field.
	accountDescPoolWeight := accountFields[10].Descriptor()
	// account.DefaultPoolWeight holds the default value on creation for the pool_weight field.
	account.DefaultPoolWeight = accountDescPoolWeight.Default.(int)
	...
	// groupDescAnthropicMixedTypeWeightEnabled is the schema descriptor for anthropic_mixed_type_weight_enabled field.
	groupDescAnthropicMixedTypeWeightEnabled := groupFields[39].Descriptor()
	// group.DefaultAnthropicMixedTypeWeightEnabled holds the default value on creation for the anthropic_mixed_type_weight_enabled field.
	group.DefaultAnthropicMixedTypeWeightEnabled = groupDescAnthropicMixedTypeWeightEnabled.Default.(bool)
	// groupDescAnthropicSetupTokenPoolWeight is the schema descriptor for anthropic_setup_token_pool_weight field.
	groupDescAnthropicSetupTokenPoolWeight := groupFields[40].Descriptor()
	// group.DefaultAnthropicSetupTokenPoolWeight holds the default value on creation for the anthropic_setup_token_pool_weight field.
	group.DefaultAnthropicSetupTokenPoolWeight = groupDescAnthropicSetupTokenPoolWeight.Default.(int)
	// groupDescAnthropicAPIKeyPoolWeight is the schema descriptor for anthropic_api_key_pool_weight field.
	groupDescAnthropicAPIKeyPoolWeight := groupFields[41].Descriptor()
