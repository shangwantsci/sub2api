...
func init() {
	...
	groupDescAnthropicMixedTypeWeightEnabled := groupFields[36].Descriptor()
	...
	groupDescAnthropicSetupTokenPoolWeight := groupFields[37].Descriptor()
	...
	groupDescAnthropicAPIKeyPoolWeight := groupFields[38].Descriptor()
