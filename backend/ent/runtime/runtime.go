...
func init() {
	...
	groupDescAnthropicMixedTypeWeightEnabled := groupFields[32].Descriptor()
	...
	groupDescAnthropicSetupTokenPoolWeight := groupFields[33].Descriptor()
	...
	groupDescAnthropicAPIKeyPoolWeight := groupFields[34].Descriptor()
