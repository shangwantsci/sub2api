...
type SystemSettings struct {
	...
	EnableContentSafetyFilter    bool
	ContentSafetyGuardMode       string
	...
	ClaudeCodeMimicryProfile               string // Claude Code 伪装 profile ID
	...
	EnablePersonaGating                    bool   // 是否启用账号人格门控：作息窗口 + 人格并发上限（默认 false）
