...
func (m *openAIWSFailoverHandlerAccountRepoStub) MinPriorityByGroup(context.Context) (map[int64]int, error) {
	return nil, nil
}
func (m *openAIWSUsageHandlerAccountRepoStub) MinPriorityByGroup(context.Context) (map[int64]int, error) {
	return nil, nil
}
