...
截至 2026-08-02 供号商账号管理面板上线：

- 镜像：`ghcr.io/shangwantsci/sub2api:0.1.156`
- 不可变镜像：`ghcr.io/shangwantsci/sub2api:0.1.156-047f4fb9`
- 应用 commit：`047f4fb9`（批量上号、二次编辑、账号邮箱与额度用量，见 4.14.2）
- 应用版本：`0.1.156`
- GitHub Actions run：`30744920471`（`custom-image` success）
- **本轮无数据库迁移**，最高迁移仍是 `183`，回滚只需切回镜像
